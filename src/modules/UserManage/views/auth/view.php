...
<?=             
            ...
            <?= Html::a(__t('app', 'Save As New'), ['save-as-new', 'id' => $model->name], ['class' => 'btn btn-info']) ?>
            <?= Html::a(__t('app', 'Update'), ['update', 'id' => $model->name], ['class' => 'btn btn-primary']) ?>
            <?= Html::a(__t('app', 'Delete'), ['delete', 'id' => $model->name], [
                'class' => 'btn btn-danger',
                'data' => [
...
if($providerAuthAssignment->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            ...
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(__t('app', 'Auth Assignment')),
        ],
...
if($providerAuthItemChild->totalCount){
    ...
    echo Gridview::widget([
        ...
        'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<span class="glyphicon glyphicon-book"></span> ' . Html::encode(__t('app', 'Auth Item Child')),
        ],
